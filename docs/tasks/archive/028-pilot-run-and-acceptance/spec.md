...
## Files Changing
- [x] Pick a target repo (recommended: the task-orchestrator repo itself or a tiny toy repo).
- [x] Create a real project config under `~/.task-orchestrator/projects/<name>.yaml` with resources + doctor + bootstrap.
